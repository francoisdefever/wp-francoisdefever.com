...
class Hestia_Select_Multiple extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'hestia-customizer-select-multiple', get_template_directory_uri() . '/inc/customizer-select-multiple/js/script-hestia-select-multiple.js', array( 'jquery', 'customize-base' ), HESTIA_VERSION, true );
